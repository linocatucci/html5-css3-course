...
<head>
    ...
    <!--Tells mobile devices not to zoom out (scale=1.0) -->
    ...
    <!-- font include in css with: font-family: 'Lato', sans-serif; -->
...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="resources/img/logo-white.png" alt="Omnifood logo" class="logo" id="logo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="resources/img/app-iPhone.png" alt="Omnifood App on iPhone" class="app-screen js--wp2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app"><img src="resources/img/download-app-android.png" alt="Android Store Button"></a>
            </div>
        </div>
    </section>
    ...
    <section class="section-testimonials">
        ...
        <div class="row">
            <div class="col span-1-of-3 box-testimonial">
                ...
                <cite><img src="resources/img/customer-1.jpg" alt="Customer 1">&mdash; Alberto Duncan</cite>
            </div>
            <div class="col span-1-of-3 box-testimonial">
                ...
                <cite><img src="resources/img/customer-2.jpg" alt="Customer 2">&mdash; Joana Silva</cite>
            </div>
            <div class="col span-1-of-3 box-testimonial">
                ...
                <cite><img src="resources/img/customer-3.jpg" alt="Customr 3">&mdash; Milton Chapman</cite>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <form method="post" action="mailer.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <?php
                        if($_GET['succes'] == 1){
                            echo "<div class=\"form-messages succes\">Thank You! Your message has been sent.</div>";
                        } 
                        
                        if($_GET['succes'] == -1){
                        echo "<div class=\"form-messages error\">Ooops, something went wrong. Please try again.
                        </div>"
                        }
                        ?>
                    </div>
